...
!
!svn $Id: inp_par.F 727 2014-03-28 21:46:14Z arango $
!================================================== Hernan G. Arango ===
...
!
!-----------------------------------------------------------------------
!  Read in turbines input parameters.
!-----------------------------------------------------------------------
!
      OPEN (60, FILE=TRIM(tposnam), FORM='formatted', STATUS='old')
      CALL read_TrbPar (model, 60, out, Lwrite)
!========================================== End of the portion =========
!
!-----------------------------------------------------------------------
