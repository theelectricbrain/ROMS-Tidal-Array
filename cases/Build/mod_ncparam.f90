      MODULE mod_ncparam
!
!svn $Id: mod_ncparam.F 719 2014-03-13 22:25:13Z arango $
!================================================== Hernan G. Arango ===
...
!
! Output identifiction turbine related quantities
!
        integer  :: id3dTF        ! 3D Turbine force
        integer  :: id3dTP        ! 3D Turbine power
        integer  :: id3dTK        ! 3D Turbine tke
        integer  :: id3dTG        ! 3D Turbine gls
!        integer  :: id3dIM        ! 3D Turbine indice-mask
        integer  :: id3dRM        ! 3D Turbine rho-mask
        integer  :: id3dUM        ! 3D Turbine u-mask
        integer  :: id3dVM        ! 3D Turbine v-mask
!========================================== End of the portion =========
!
...
!  analytical expression directory.
!
      Rdir="/home/thomas/Desktop/ROMS_latest_patched"
      Hdir="/home/thomas/Desktop/ROMS_latest_patched/cases"
      Hfile="validation.h"
      Adir="/home/thomas/Desktop/ROMS_latest_patched/cases/Functionals"
!
!-----------------------------------------------------------------------
