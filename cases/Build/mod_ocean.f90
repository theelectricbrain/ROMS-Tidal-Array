      MODULE mod_ocean
!
!svn $Id: mod_ocean.F 709 2014-01-23 20:09:38Z arango $
!================================================== Hernan G. Arango ===
...
! The following portion is Copyright (c) 2014 Thomas Roc and ITPower   !
          real(r8), pointer :: dragfrc(:,:,:,:)
          real(r8), pointer :: dragpwr(:,:,:,:)
          real(r8), pointer :: dragtke(:,:,:,:)
          real(r8), pointer :: draggls(:,:,:,:)
!========================================== End of the portion =========
        END TYPE T_OCEAN
...
!================================================== Thomas Roc =========
! The following portion is Copyright (c) 2014 Thomas Roc and ITPower   !
      allocate ( OCEAN(ng) % dragfrc(LBi:UBi,LBj:UBj,N(ng),2) )
      allocate ( OCEAN(ng) % dragpwr(LBi:UBi,LBj:UBj,N(ng),2) )
      allocate ( OCEAN(ng) % dragtke(LBi:UBi,LBj:UBj,N(ng),2) )
      allocate ( OCEAN(ng) % draggls(LBi:UBi,LBj:UBj,N(ng),2) )
!========================================== End of the portion =========
      RETURN
...
!================================================== Thomas Roc =========
! The following portion is Copyright (c) 2014 Thomas Roc and ITPower   !
              OCEAN(ng) % dragfrc(i,j,k,1) = IniVal
              OCEAN(ng) % dragfrc(i,j,k,2) = IniVal
              OCEAN(ng) % dragpwr(i,j,k,1) = IniVal
              OCEAN(ng) % dragpwr(i,j,k,2) = IniVal
              OCEAN(ng) % dragtke(i,j,k,1) = IniVal
              OCEAN(ng) % dragtke(i,j,k,2) = IniVal
              OCEAN(ng) % draggls(i,j,k,1) = IniVal
              OCEAN(ng) % draggls(i,j,k,2) = IniVal
!========================================== End of the portion =========
            END DO
          END DO
          DO k=0,N(ng)
