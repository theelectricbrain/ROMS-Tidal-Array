      MODULE mod_strings
!
!svn $Id: mod_strings.F 709 2014-01-23 20:09:38Z arango $
!================================================== Hernan G. Arango ===
...
!
     ...
     &      'Message Passage: multi-model coupling ............'/)
        ...
        character (len=160) :: my_fflags = "-frepack-arrays -O3 -ffast-math -ffree-form -ffree-line-length-none -ffree-form -ffree-line-length-none -ffree-form -ffree-line-length-none"
