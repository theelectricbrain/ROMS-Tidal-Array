...
!
!svn $Id: def_his.F 727 2014-03-28 21:46:14Z arango $
!================================================== Hernan G. Arango ===
...
! The following portion is Copyright (c) 2014 Thomas Roc and ITPower   !
          Vinfo( 1)=Vname(1,id3dTF)
          Vinfo( 2)=Vname(2,id3dTF)
          Vinfo( 3)=Vname(3,id3dTF)
          Vinfo(14)=Vname(4,id3dTF)
          Vinfo(16)=Vname(1,id3dTF)
!          Vinfo(20)='umask_t'
          Vinfo(20)='mask_u'
          Vinfo(22)='coordinates'
          Aval(5)=REAL(u3dvar,r8)
!          Aval(5)=REAL(Iinfo(1,id3dTF,ng),r8)
          status=def_var(ng, iNLM, HIS(ng)%ncid, HIS(ng)%Vid(id3dTF),   &
     &                   NF_FOUT, nvd4, u3dgrd, Aval, Vinfo, ncname)
          IF (exit_flag.ne.NoError) RETURN
          Vinfo( 1)=Vname(1,id3dTP)
          Vinfo( 2)=Vname(2,id3dTP)
          Vinfo( 3)=Vname(3,id3dTP)
          Vinfo(14)=Vname(4,id3dTP)
          Vinfo(16)=Vname(1,id3dTP)
!          Vinfo(20)='umask_t'
          Vinfo(20)='mask_u'
          Vinfo(22)='coordinates'
          Aval(5)=REAL(u3dvar,r8)
!          Aval(5)=REAL(Iinfo(1,id3dTP,ng),r8)
          status=def_var(ng, iNLM, HIS(ng)%ncid, HIS(ng)%Vid(id3dTP),   &
     &                   NF_FOUT, nvd4, u3dgrd, Aval, Vinfo, ncname)
          IF (exit_flag.ne.NoError) RETURN
          Vinfo( 1)=Vname(1,id3dTK)
          Vinfo( 2)=Vname(2,id3dTK)
          Vinfo( 3)=Vname(3,id3dTK)
          Vinfo(14)=Vname(4,id3dTK)
          Vinfo(16)=Vname(1,id3dTK)
!          Vinfo(20)='rmask_t'
          Vinfo(20)='mask_rho'
          Vinfo(22)='coordinates'
          Aval(5)=REAL(r3dvar,r8)
!          Aval(5)=REAL(Iinfo(1,id3dTP,ng),r8)
          status=def_var(ng, iNLM, HIS(ng)%ncid, HIS(ng)%Vid(id3dTK),   &
     &                   NF_FOUT, nvd4, w3dgrd, Aval, Vinfo, ncname)
          IF (exit_flag.ne.NoError) RETURN
          Vinfo( 1)=Vname(1,id3dTG)
          Vinfo( 2)=Vname(2,id3dTG)
          Vinfo( 3)=Vname(3,id3dTG)
          Vinfo(14)=Vname(4,id3dTG)
          Vinfo(16)=Vname(1,id3dTG)
!          Vinfo(20)='rmask_t'
          Vinfo(20)='mask_rho'
          Vinfo(22)='coordinates'
          Aval(5)=REAL(r3dvar,r8)
!          Aval(5)=REAL(Iinfo(1,id3dTP,ng),r8)
          status=def_var(ng, iNLM, HIS(ng)%ncid, HIS(ng)%Vid(id3dTG),   &
     &                   NF_FOUT, nvd4, w3dgrd, Aval, Vinfo, ncname)
          IF (exit_flag.ne.NoError) RETURN
!          Vinfo( 1)=Vname(1,id3dIM)
!          Vinfo( 2)=Vname(2,id3dIM)
!          Vinfo( 3)=Vname(3,id3dIM)
!          Vinfo(14)=Vname(4,id3dIM)
!          Vinfo(16)=Vname(1,id3dIM)
!          Vinfo(20)='mask_u'
!          Vinfo(22)='coordinates'
!          Aval(5)=REAL(u3dvar,r8)
!          status=def_var(ng, iNLM, HIS(ng)%ncid, HIS(ng)%Vid(id3dIM),  &
!     &                   NF_FOUT, nvd4, u3dgrd, Aval, Vinfo, ncname)
!          IF (exit_flag.ne.NoError) RETURN
!
          Vinfo( 1)=Vname(1,id3dRM)
          Vinfo( 2)=Vname(2,id3dRM)
          Vinfo( 3)=Vname(3,id3dRM)
          Vinfo(14)=Vname(4,id3dRM)
          Vinfo(16)=Vname(1,id3dRM)
          Vinfo(20)='rmask_t'
          Vinfo(20)='mask_rho'
          Vinfo(22)='coordinates'
          Aval(5)=REAL(r3dvar,r8)
!          Aval(5)=REAL(Iinfo(1,id3dTP,ng),r8)
          status=def_var(ng, iNLM, HIS(ng)%ncid, HIS(ng)%Vid(id3dRM),   &
     &                   NF_FOUT, nvd3, w3dgrd, Aval, Vinfo, ncname)
          IF (exit_flag.ne.NoError) RETURN
          Vinfo( 1)=Vname(1,id3dUM)
          Vinfo( 2)=Vname(2,id3dUM)
          Vinfo( 3)=Vname(3,id3dUM)
          Vinfo(14)=Vname(4,id3dUM)
          Vinfo(16)=Vname(1,id3dUM)
!          Vinfo(20)='umask_t'
          Vinfo(20)='mask_u'
          Vinfo(22)='coordinates'
          Aval(5)=REAL(u3dvar,r8)
!          Aval(5)=REAL(Iinfo(1,id3dTP,ng),r8)
          status=def_var(ng, iNLM, HIS(ng)%ncid, HIS(ng)%Vid(id3dUM),   &
     &                   NF_FOUT, nvd3, u3dgrd, Aval, Vinfo, ncname)
          IF (exit_flag.ne.NoError) RETURN
          Vinfo( 1)=Vname(1,id3dVM)
          Vinfo( 2)=Vname(2,id3dVM)
          Vinfo( 3)=Vname(3,id3dVM)
          Vinfo(14)=Vname(4,id3dVM)
          Vinfo(16)=Vname(1,id3dVM)
!          Vinfo(20)='vmask_t'
          Vinfo(20)='mask_v'
          Vinfo(22)='coordinates'
          Aval(5)=REAL(v3dvar,r8)
!          Aval(5)=REAL(Iinfo(1,id3dTP,ng),r8)
          status=def_var(ng, iNLM, HIS(ng)%ncid, HIS(ng)%Vid(id3dVM),   &
     &                   NF_FOUT, nvd3, v3dgrd, Aval, Vinfo, ncname)
          IF (exit_flag.ne.NoError) RETURN
        END IF
!========================================== End of the portion =========
!
...
!================================================== Thomas Roc =========
! The following portion is Copyright (c) 2014 Thomas Roc and ITPower   !
          ELSE IF (TRIM(var_name(i)).eq.TRIM(Vname(1,id3dTF))) THEN
            got_var(id3dTF)=.TRUE.
            HIS(ng)%Vid(id3dTF)=var_id(i)
          ELSE IF (TRIM(var_name(i)).eq.TRIM(Vname(1,id3dTP))) THEN
            got_var(id3dTP)=.TRUE.
            HIS(ng)%Vid(id3dTP)=var_id(i)
          ELSE IF (TRIM(var_name(i)).eq.TRIM(Vname(1,id3dTK))) THEN
            got_var(id3dTK)=.TRUE.
            HIS(ng)%Vid(id3dTK)=var_id(i)
          ELSE IF (TRIM(var_name(i)).eq.TRIM(Vname(1,id3dTG))) THEN
            got_var(id3dTG)=.TRUE.
            HIS(ng)%Vid(id3dTG)=var_id(i)
!          ELSE IF (TRIM(var_name(i)).eq.TRIM(Vname(1,id3dIM))) THEN
!            got_var(id3dIM)=.TRUE.
!            HIS(ng)%Vid(id3dIM)=var_id(i)
          ELSE IF (TRIM(var_name(i)).eq.TRIM(Vname(1,id3dRM))) THEN
            got_var(id3dRM)=.TRUE.
            HIS(ng)%Vid(id3dRM)=var_id(i)
          ELSE IF (TRIM(var_name(i)).eq.TRIM(Vname(1,id3dUM))) THEN
            got_var(id3dUM)=.TRUE.
            HIS(ng)%Vid(id3dUM)=var_id(i)
          ELSE IF (TRIM(var_name(i)).eq.TRIM(Vname(1,id3dVM))) THEN
            got_var(id3dVM)=.TRUE.
            HIS(ng)%Vid(id3dVM)=var_id(i)
!========================================== End of the portion =========
