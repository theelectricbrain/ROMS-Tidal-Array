      MODULE mod_scalars
!
!svn $Id: mod_scalars.F 727 2014-03-28 21:46:14Z arango $
!================================================== Hernan G. Arango ===
...
! The following portion is Copyright (c) 2014 Thomas Roc and ITPower   
          integer, pointer :: Tc(:)
          real(r8), pointer :: Txpos(:)
          real(r8), pointer :: Typos(:)
          real(r8), pointer :: Tzpos(:)
          real(r8), pointer :: Tct(:)
          real(r8), pointer :: Ttke(:)
          real(r8), pointer :: Tgls(:)
          real(r8), pointer :: Tlc(:)
          real(r8), pointer :: Tpa(:)
          real(r8), pointer :: Tdiam(:)
!========================================== End of the portion =========
