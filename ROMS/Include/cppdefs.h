...
** CUSTOM OPTIONS - deloped by Thomas Roc for IT Power Ltd -                 **
**                                                                           **
** TIDAL_TURBINE       use if modelling tidal turbines                       **
** I_ORIENTATION       use if tidal turbines facing the I direction          **
** J_ORIENTATION       use if tidal turbines facing the J direction          **
**                                                                           **
